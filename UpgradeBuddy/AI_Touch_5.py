...
def ProcessResponse():
    ...
    new_speaker = new_speaker.strip() + " Thanks Upgrade Buddy."
...
if len(prompt)!=1:
    prompt_for_content = ("You are an expert in Instagram reels script writer creating viral and shareable scripts. I am a "
                          "script writer for a tech news channel named as Upgrade Buddy who has mostly audience of age between 18 to 26 from India. Create a reels script with the above news in MY format." + my_format_prompt + "Example : If you're a student, you need to watch this! Elon Musk says AI will replace all "
    ...
    prompt_for_content = (
                ...
                "script writer for a tech news named as Upgrade Buddy who has mostly audience of age between 18 to 26 from India. Create a reels script with my rough script idea in My format." + prompt[0] + my_format_prompt +"\n"
    )
